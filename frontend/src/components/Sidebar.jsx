...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { text: 'Purchase Orders', icon: <ShoppingCartIcon />, path: '/po', roles: ['ADMIN', 'PROCUREMENT_OFFICER'], section: 'workflow' },
    { text: 'PO Approval', icon: <CheckCircleIcon />, path: '/po-approval', roles: ['ADMIN', 'PROCUREMENT_OFFICER'], section: 'workflow' },
